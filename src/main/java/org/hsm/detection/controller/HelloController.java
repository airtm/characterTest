...
//        hashMap.put("test1","B");
//        hashMap.put("test2","C");
//        map.addAllAttributes(hashMap);
        //  return模板文件的名称，对应src/main/resources/templates/index.html
        return "index";
    }

    @RequestMapping(value = "/add")
    public String save(@ModelAttribute(value = "message") Message message, ModelMap map,HttpServletRequest request) {
        String[] fieldNames = getFiledName(message);
...
//            }
        ...
        map.addAttribute("result", "比重："+红色+蓝色+黄色+绿色);
        map.addAttribute("explain", "说明：");
        map.addAttribute("explain1", result1);
        map.addAttribute("explain2", result2);
        map.addAttribute("explain3", result3);
